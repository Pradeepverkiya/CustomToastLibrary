package realtimesdk.realtimebiometric.com.androidlibrary;
...
public class CustomToast {
    ...
    public static Toast normal(@NonNull Context context, @StringRes int message, int duration,
        ...
        return custom(context, context.getString(message), icon, CustomToastUtils.getColor(context, R.color.normalColor),
                CustomToastUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }

    @CheckResult
    public static Toast normal(@NonNull Context context, @NonNull CharSequence message, int duration,
                               Drawable icon, boolean withIcon) {
        return custom(context, message, icon, CustomToastUtils.getColor(context, R.color.normalColor),
                CustomToastUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CustomToastUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                CustomToastUtils.getColor(context, R.color.warningColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast warning(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CustomToastUtils.getDrawable(context, R.drawable.ic_error_outline_white_24dp),
                CustomToastUtils.getColor(context, R.color.warningColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast info(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CustomToastUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                CustomToastUtils.getColor(context, R.color.infoColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast info(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CustomToastUtils.getDrawable(context, R.drawable.ic_info_outline_white_24dp),
                CustomToastUtils.getColor(context, R.color.infoColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast success(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CustomToastUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                CustomToastUtils.getColor(context, R.color.successColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast success(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CustomToastUtils.getDrawable(context, R.drawable.ic_check_white_24dp),
                CustomToastUtils.getColor(context, R.color.successColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast error(@NonNull Context context, @StringRes int message, int duration, boolean withIcon) {
        return custom(context, context.getString(message), CustomToastUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                CustomToastUtils.getColor(context, R.color.errorColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }

    @CheckResult
    public static Toast error(@NonNull Context context, @NonNull CharSequence message, int duration, boolean withIcon) {
        return custom(context, message, CustomToastUtils.getDrawable(context, R.drawable.ic_clear_white_24dp),
                CustomToastUtils.getColor(context, R.color.errorColor), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, true);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
        ...
        return custom(context, context.getString(message), icon, -1, CustomToastUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
                               int duration, boolean withIcon) {
        return custom(context, message, icon, -1, CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, false);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, @DrawableRes int iconRes,
        ...
        return custom(context, context.getString(message), CustomToastUtils.getDrawable(context, iconRes),
                CustomToastUtils.getColor(context, tintColorRes), CustomToastUtils.getColor(context, R.color.defaultTextColor),
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, @DrawableRes int iconRes,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, message, CustomToastUtils.getDrawable(context, iconRes),
                CustomToastUtils.getColor(context, tintColorRes), CustomToastUtils.getColor(context, R.color.defaultTextColor),
                duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               @ColorRes int tintColorRes, int duration,
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, CustomToastUtils.getColor(context, tintColorRes),
                CustomToastUtils.getColor(context, R.color.defaultTextColor), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @StringRes int message, Drawable icon,
                               ...
                               boolean withIcon, boolean shouldTint) {
        return custom(context, context.getString(message), icon, CustomToastUtils.getColor(context, tintColorRes),
                CustomToastUtils.getColor(context, textColorRes), duration, withIcon, shouldTint);
    }
    ...
    public static Toast custom(@NonNull Context context, @NonNull CharSequence message, Drawable icon,
        ...
        if (shouldTint)
            ...
            drawableFrame = CustomToastUtils.getDrawable(context, R.drawable.toast_frame);
        CustomToastUtils.setBackground(toastLayout, drawableFrame);

        if (withIcon) {
            if (icon == null)
                throw new IllegalArgumentException("Avoid passing 'icon' as null if 'withIcon' is set to true");
            CustomToastUtils.setBackground(toastIcon, tintIcon ? CustomToastUtils.tintIcon(icon, textColor) : icon);
        } else {
    ...
    public static class Config {
        ...
        public void apply() {
            ...
            CustomToast.allowQueue = allowQueue;
        }
    }
}
